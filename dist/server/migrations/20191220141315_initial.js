...
exports.up = function (knex) {
  return knex.schema.createTable('setting', function (table) {
  ...
  }).createTable('user_place', function (table) {
    table.increments('id').primary();
    ...
    table.text('description');
    table.text('image');
  }).createTable('tweet_webpage', function (table) {
    ...
    table.datetime('created').defaultsTo(knex.fn.now());
  }).createTable('tweet_hashtag', function (table) {
    table.integer('tweet_id').notNullable();
...
exports.down = function (knex) {
  return knex.schema.dropTable('setting').dropTable('user').dropTable('place').dropTable('trend').dropTable('collection').dropTable('query').dropTable('tweet').dropTable('webpage').dropTable('hashtag');
};