    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return knex.schema.alterTable('search_job', function (table) {
              table.string('type').defaultTo('stream');
            });

          case 2:
            return _context.abrupt("return", knex.schema.alterTable('search_job', function (table) {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", knex.schema.alterTable('search_job', function (table) {
