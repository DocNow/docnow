    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", knex.schema.alterTable('action', function (table) {
              table.integer('tweetId').nullable().alter();
              table.dropForeign(null, 'action_tweetid_foreign');
              table.foreign('tweetId').references('id').inTable('tweet').onDelete('SET NULL');
            }));
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", knex.schema.alterTable('action', function (table) {
              table.dropForeign(null, 'action_tweetid_foreign');
